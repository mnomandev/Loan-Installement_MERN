...
>
  ...
  <div className="md:col-span-2 border-t pt-4">
    <h3 className="text-lg font-semibold mb-2 text-green-700">Borrower Details</h3>
  ...
  <div className="md:col-span-2">
    <h3 className="text-lg font-semibold mb-2 text-green-700">Guarantor Details</h3>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      <Input label="Full Name">
  ...
  {/* --- Item --- */}
  <div className="md:col-span-2 border-t pt-4">
    <h3 className="text-lg font-semibold mb-2 text-green-700">Item / Vehicle Details</h3>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      <Input label="Item">
  ...
  {/* --- Installment Plan --- */}
  <div className="md:col-span-2">
    <h3 className="text-lg font-semibold mb-2 text-green-700">Installment Plan</h3>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
  ...
  <div className="md:col-span-2">
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 gap-2">
      <h3 className="text-lg font-semibold text-green-700">Installment Ledger (optional)</h3>
      <button
        type="button"
        className="px-3 py-2 rounded-xl shadow w-full sm:w-auto"
        onClick={() =>
          append({
        ...
        <tbody>
          {fields.map((f, idx) => (
            <tr key={f.id} className="border-t">
              ...
              <td className="p-2">
                <button type="button" className="px-2 py-1 rounded bg-red-100" onClick={() => remove(idx)}>
                  Remove
                </button>
              </td>
            </tr>
  ...
  <div className="md:col-span-2 flex flex-col sm:flex-row gap-3 justify-end">
    <button type="submit" className="px-4 py-2 rounded-2xl shadow w-full sm:w-auto">
  ...
  <style>{`.input{border:1px solid #e5e7eb;border-radius:0.75rem;padding:0.5rem 0.75rem;width:100%;}`}</style>
</form>
  );
}
